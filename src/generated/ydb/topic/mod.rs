...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AddOffsetsToTransactionRequest {
    #[prost(message, optional, tag = "1")]
    ...
    #[prost(message, optional, tag = "3")]
    pub tx_control: ::core::option::Option<super::table::TransactionControl>,
    /// Ranges of offsets by topics.
    #[prost(message, repeated, tag = "4")]
    pub topics: ::prost::alloc::vec::Vec<
        add_offsets_to_transaction_request::TopicOffsets,
    >,
    #[prost(string, tag = "5")]
    pub consumer: ::prost::alloc::string::String,
}
/// Nested message and enum types in `AddOffsetsToTransactionRequest`.
pub mod add_offsets_to_transaction_request {
    #[allow(clippy::derive_partial_eq_without_eq)]
    #[derive(Clone, PartialEq, ::prost::Message)]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AddOffsetsToTransactionResponse {
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AddOffsetsToTransactionResult {}
